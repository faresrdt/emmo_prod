...
////////////////////////////////////////////////////////////// INPUT TYPE DE BIENS
$('.input-type-rent').click(function(){
...
$('.input-city-rent').click(function(){
...
$('.input-rent, .RentFilter').click(function(){

    $.ajax({

        url:'../library/RentFilter.php',
        type:'get',
            ...
            {                
                $('.result').append('<div class="col-sm-10 col-md-6 col-lg-4 mt-4">' +
                                        '<div class="card ' + result[i].titre + '">'+
                                            ...
                                            '<span class="col-md-6">' + new Intl.NumberFormat().format(result[i].prix) + '€/mois</span>'+
